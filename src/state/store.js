...
store.signup = action(function signup(firstname, lastname, email, password) {
  store.startAction();
  return store.gotrue
    .signup(email, password, { first_name: firstname, last_name: lastname, full_name: firstname + ' ' + lastname })
    .then(
      action(() => {
